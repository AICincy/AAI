...
|---|---|---|
| Deficit framing | AuDHD described as limitation requiring simplification | Apply cognitive-interface contract before drafting |
| Scaffolding creep | Output explains basics instead of producing artifact | Lead with synthesis and deliverable |
...
| Recap burden | Continue command triggers summary instead of resumption | Resume at interruption point |
| Multi-thread diffusion | Secondary issue interrupts the primary objective | Park secondary issue |

## Remediation Format

When an error occurs, state:
