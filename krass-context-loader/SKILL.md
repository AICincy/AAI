...
description: Loads prior and case-specific context before Krass outputs. Use when a request references prior work, medical information, provider relationships, legal matters, financial accounts, transit constraints, facility exclusions, local recommendations, or any continuing case narrative that depends on remembered facts.
---
